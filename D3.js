...
for (let i = 0; i < starWarsCharacters.length; i++) {
  switch (starWarsCharacters[i].eye_color) {
    ...
    case "blue-gray":
      ...
      break;
    default:
      console.log(" ERRORE, COLORE DI OCCHI NON RICONOSCIUTO");
  }
}
...
for (let i=0 ; i<femaleCharacters.length; i++)
   for (let j=0; j<charactersName.length; j++)
      if (femaleCharacters[i].name === charactersName[j]){
        charactersName.splice(j,1)
      }
/* --EXTRA-- ESERCIZIO 10
